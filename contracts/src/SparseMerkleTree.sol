...
contract SparseMerkleTree {
    ...
    function zeros(uint256 i) public pure returns (uint256) {
        if (i == 0)
            ...
            return
                uint256(
                    0x020a474de93592d5b1127589ba705a0f0016ab559a799b0c7ce76429b3243b0a
                );
        else if (i == 7)
            return
                uint256(
            ...
            return
                uint256(
                    0x2d51a6c6968f7f9937b0ce246700a7ef2642d602704affe3f6826099ae89c314
                );
        else if (i == 22)
            return
                uint256(
                    0x040c403e552a7da3347a814cfa68f7179022f4bad093f5d51c36f274e6c00216
                );
        else if (i == 23)
            return
                uint256(
                    0x2b51a6f81676a81df506994d2a2fe42221636a7be5316dda9e72a4cfb4b6713e
                );
        else if (i == 24)
            return
                uint256(
                    0x09bac36c373cabdce29c71d6b6ff3bce8f23697cc8fc1bf773764e8c6c87106a
                );
        else if (i == 25)
            return
                uint256(
                    0x1ac61b00797e2af34f53e095ba779bfe5585f1028e99b93853fd7f6ac2695ec6
                );
        else if (i == 26)
            return
                uint256(
                    0x14126628e2921bf57d06edeebe4b4d765b78098face56dd6c3ff3863fa8d4e14
                );
        else if (i == 27)
            return
                uint256(
                    0x10b85caa5c83624cbbf38bc8e4e50fd7ccae13bfc56cae2fe5aef4b63f5d213a
                );
        else if (i == 28)
            return
                uint256(
                    0x2e8383359c191e60d2d64cee201f80417bfd23e25e8b459f38eb0dcef5d27d3e
                );
        else if (i == 29)
            return
                uint256(
                    0x282dc9be0b4e379381b409259502806071421b72e80ed43b74f6771a2c7588fd
                );
        else if (i == 30)
            return
                uint256(
                    0x03b92d4561fbbafc65869388f1ca7983d1ea6786cd92d36f1d9cc615c4e90e5e
                );
        else if (i == 31)
            return
                uint256(
                    0x225e55edbfb735fa5dc7b2253e85fa2d785f4d501bf739c1e01cd9945a614142
                );
        else if (i == 32)
            return
                uint256(
                    0x1c84fa6e48fb98cd6e53564789999218f732cd6df3d996f8b171f837c141adc3
                );
